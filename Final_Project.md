...
```
    ...
    Your credentails:
    CLIENT_ID: BXDCG5XLBVMUSPMCT0YYQWND1G3AP4AZX2QK42SGXINC4VOI
    CLIENT_SECRET:MYDFY1NXKYXUFSYUKZQH51N2QMUJU1ZYPQXBYOBCZI3AFXCZ
...
```
    ...
    <ipython-input-61-033d498bfa5c> in <module>
    ----> 1 dataset.to_csv("dataset.csv")
          2 #read it back
